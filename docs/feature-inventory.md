...
| Agent foundation | Internal durable AgentRun acceptance with organization-scoped idempotency; no public execution API or production agent definition yet | `apps/backend/src/agents/`, `apps/backend/prisma/schema.prisma` |
