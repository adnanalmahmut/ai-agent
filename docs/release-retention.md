...
Retention also remains untouched at host bundle 8. That bundle changes the
Platform service from the static runtime to the Next.js server and supplies its
