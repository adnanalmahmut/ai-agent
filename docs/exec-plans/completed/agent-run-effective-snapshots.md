...
`826a3b60a84f8fd2900f39b23e79aff21ed88332`.
...
- Changing installation/version management, adding agent settings, or adding
  a Platform installation-management UI.
...
- Backfilling historical runs to guessed installations or mutating immutable
...
- ContentIdeaService adds `agent_not_installed` and `agent_disabled` availability
  ...
  explains the refusal when multiple gates are closed.
