...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      {/*
        `data-[side=left|right]:slide-in-from-*` is intentionally physical:
        Radix reports the *physical* side the popper was placed on, so the
        entrance animation must originate from the physical opposite edge.
        Converting these to logical properties would break the animation in
        both directions. See packages/ui RTL notes.
      */}
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      {/*
        Directional icon: the submenu opens along the reading direction, so
        the chevron follows it. Flipped for RTL on purpose — unlike logos,
        media controls or status icons, which must never be mirrored.
      */}
