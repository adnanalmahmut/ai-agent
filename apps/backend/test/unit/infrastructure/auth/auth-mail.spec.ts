...
import type { MailService } from '../../../../src/infrastructure/mail';
import type { MailJob } from '../../../../src/infrastructure/mail';
import {
  createAuthMailCallbacks,
  type AuthMailOptions,
} from '../../../../src/infrastructure/auth/auth-mail';
