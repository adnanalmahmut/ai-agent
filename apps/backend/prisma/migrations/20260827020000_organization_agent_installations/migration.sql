...
-- AddForeignKey
ALTER TABLE "organization_agent_installation" ADD CONSTRAINT "organization_agent_installation_activeVersionId_id_fkey" FOREIGN KEY ("activeVersionId", "id") REFERENCES "organization_agent_version"("id", "installationId") ON DELETE RESTRICT ON UPDATE CASCADE;
