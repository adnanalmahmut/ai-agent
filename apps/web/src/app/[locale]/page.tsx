...
export default async function HomePage() {
  ...
  const [
    ...
    getTranslations('Foundations'),
    getTranslations('Colors'),
    getTranslations('Typography'),
    getTranslations('Surfaces'),
    getTranslations('Buttons'),
    getTranslations('Dialogs'),
    getTranslations('Inputs'),
    getTranslations('Cards'),
    getTranslations('Internationalization'),
    getTranslations('Formatting'),
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 md:px-8">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-none">
              <div className="text-sm font-semibold">{tShowcase('brand')}</div>
              <div className="mt-1 text-xs text-muted-foreground">
                {tShowcase('brandDescription')}
              </div>
            </div>
          </div>
